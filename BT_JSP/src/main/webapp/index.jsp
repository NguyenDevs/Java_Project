...
<body>
<form class="form" action="PlaceOrder.jsp" method="post">
    <h1 class="header">Order Form</h1>
        <label class="texter">
        Number to purchase:
        <input type="text" class="info" name="number" required>
    </label>
    <br>
    <label class="texter"> Your Name:
        <input type="text" class="info" name="name" required>
    </label>
    <br>
    <label class="texter"> Your email:
        <input type="text" class="info" name="email" required>
    </label>
    <br>
